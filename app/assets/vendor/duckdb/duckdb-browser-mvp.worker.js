...
var duckdb = (() => {
  ...
  var kp = hs((Ep, rl) => {
    ...
    var Dp = (() => {
      ...
      return typeof __filename < "u" && (i = i || __filename), function (t = {}) {
        ...
        var e_ = "data:application/octet-stream;base64,", hl = n => n.startsWith(e_), pl = n => n.startsWith("file://"),
          gr;
        ...
        var ss = n => n % 4 === 0 && (n % 100 !== 0 || n % 400 === 0), xy = (n, s) => {
            ...
            return o
          }, xl = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Tl = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
          Ty = (n, s) => {
  ...
  var oj = i => $e(Int8Array, i), aj = i => $e(Int16Array, i), lj = i => $e(Int32Array, i), aa = i => $e(Uint8Array, i),
    cj = i => $e(Uint16Array, i), uj = i => $e(Uint32Array, i), dj = i => $e(Float32Array, i),
    fj = i => $e(Float64Array, i), hj = i => $e(Uint8ClampedArray, i);
  ...
  var pj = i => Te(Int8Array, i), _j = i => Te(Int16Array, i), yj = i => Te(Int32Array, i), la = i => Te(Uint8Array, i),
    mj = i => Te(Uint16Array, i), bj = i => Te(Uint32Array, i), vj = i => Te(Float32Array, i),
    gj = i => Te(Float64Array, i), wj = i => Te(Uint8ClampedArray, i);
  ...
  var Aj = (i, t, e) => {
    ...
    Lj = (i, t) => (e, r, c, h) => r && e(r, i, t.get(c.name)), Pj = (i, t) => (e, r, c, h) => r && e(r, i, t[c.name]),
    Vj = (i, t, e) => {
  ...
  var $j = (i, t) => 864e5 * i[t], Fa = (i, t) => 4294967296 * i[t + 1] + (i[t] >>> 0),
    ...
    Th = ({values: i}, t) => Fa(i, t * 2), Dh = ({values: i}, t) => Yj(i, t * 2), Eh = ({values: i}, t) => Xj(i, t * 2),
    sS = (i, t) => {
      switch (i.type.unit) {
        case lt.SECOND:
          return xh(i, t);
  ...
  var Da = class i extends H {
    ...
    visitFixedSizeBinary(t) {
      let {["type"]: e, ["offset"]: r = 0} = t, c = J(t.nullBitmap),
        h = st(e.ArrayType, t.data), {["length"]: y = h.length / fe(e), ["nullCount"]: m = t.nullBitmap ? -1 : 0} = t;
      return new bt(e, r, y, m, [void 0, h, c])
    }
    ...
    visitMap(t) {
      let {["type"]: e, ["offset"]: r = 0, ["child"]: c = new i().visit({type: e.childType})} = t, h = J(t.nullBitmap),
        y = tr(t.valueOffsets), {["length"]: m = y.length - 1, ["nullCount"]: v = t.nullBitmap ? -1 : 0} = t;
      return new bt(e, r, m, v, [y, void 0, h], [c])
    }
  };
  ...
  var Lr = 8, Na = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8], Bn = class {
    ...
    static fromString(t, e = new Uint32Array(4)) {
      let r = t.startsWith("-"), c = t.length, h = new i(e);
      for (let y = r ? 1 : 0; y < c;) {
        let m = Lr < c - y ? Lr : c - y, v = new i(new Uint32Array([Number.parseInt(t.slice(y, y + m), 10), 0, 0, 0])),
  ...
  function zS(i, t) {
    let e = [...i.fields], r = [], c = {numBatches: t.reduce((E, k) => Math.max(E, k.length), 0)}, h = 0, y = 0, m = -1,
      v = t.length, C, A = [];
    for (; c.numBatches-- > 0;) {
  ...
  var Xa = i => "Expected ".concat(ft[i], " Message in stream, but was null or length 0."),
    ...
    bp = (i, t) => "Expected to read ".concat(i, " bytes for message body, but only read ").concat(t, "."), $r = class {
      constructor(t) {
  ...
  function vI(i) {
    ...
    if (t.mode === Bt.Dense) {
      ...
      {
        let h = r.reduce((A, E) => Math.max(A, E), r[0]), y = new Int32Array(h + 1), m = new Int32Array(h + 1).fill(-1),
          v = new Int32Array(e), C = sn(-c[0], e, c);
